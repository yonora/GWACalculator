function add(){
    ...
    lastIndex = row[row.length - 1];
    container.insertAdjacentHTML(
        'beforeend', 
        `<div class="grade-container" id=${lastIndex.id}>
            <div class="col-auto">
    ...
    var previousIndex = document.querySelectorAll('.grade-container');
    previousIndex = previousIndex[previousIndex.length - 2];
    previousIndex.insertAdjacentHTML(
        'beforeend', 
